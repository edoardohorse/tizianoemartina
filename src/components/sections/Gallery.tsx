			...
			<div className={styles.wrapper}>
				...
				<div className={styles.appBtns_wrapper}>
					...
					<a className={styles.appBtns}
					   href='https://play.google.com/store/apps/details?id=net.bodas.android.wedshoots&pcampaignid=web_share&pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1'><img
